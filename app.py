...
def copy_code(code):
    ...
    st.toast(f"Copied {code} - Liqa a wayarka ka kira!", icon="✅")
...
# USSD CODES PAGE - SABBIN CODES + ICONS + COPY
    ...
    with tab1:
        ...
        with col2:
            ...
            if st.button("Copy *310#", key="mtn_balance", use_container_width=True):
                copy_code("*310#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *312#", key="mtn_data", use_container_width=True):
                copy_code("*312#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *311*", key="mtn_recharge", use_container_width=True):
                copy_code("*311*")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *323#", key="mtn_data_bal", use_container_width=True):
                copy_code("*323#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *303#", key="mtn_borrow", use_container_width=True):
                copy_code("*303#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *321#", key="mtn_share", use_container_width=True):
                copy_code("*321#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *996#", key="mtn_nin", use_container_width=True):
                copy_code("*996#")
            st.markdown("</div>", unsafe_allow_html=True)
    ...
    with tab2:
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *310#", key="glo_balance", use_container_width=True):
                copy_code("*310#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *312#", key="glo_data", use_container_width=True):
                copy_code("*312#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *311*", key="glo_recharge", use_container_width=True):
                copy_code("*311*")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *323#", key="glo_data_bal", use_container_width=True):
                copy_code("*323#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *303#", key="glo_borrow", use_container_width=True):
                copy_code("*303#")
            st.markdown("</div>", unsafe_allow_html=True)
    ...
    with tab3:
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *310#", key="airtel_balance", use_container_width=True):
                copy_code("*310#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *312#", key="airtel_data", use_container_width=True):
                copy_code("*312#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *311*", key="airtel_recharge", use_container_width=True):
                copy_code("*311*")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *323#", key="airtel_data_bal", use_container_width=True):
                copy_code("*323#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *303#", key="airtel_borrow", use_container_width=True):
                copy_code("*303#")
            st.markdown("</div>", unsafe_allow_html=True)
    ...
    with tab4:
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *310#", key="9mobile_balance", use_container_width=True):
                copy_code("*310#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *312#", key="9mobile_data", use_container_width=True):
                copy_code("*312#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *311*", key="9mobile_recharge", use_container_width=True):
                copy_code("*311*")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *323#", key="9mobile_data_bal", use_container_width=True):
                copy_code("*323#")
            st.markdown("</div>", unsafe_allow_html=True)
        ...
        with col2:
            st.markdown('<div class="copy-btn">', unsafe_allow_html=True)
            if st.button("Copy *303#", key="9mobile_borrow", use_container_width=True):
                copy_code("*303#")
            st.markdown("</div>", unsafe_allow_html=True)
    ...
    st.success("**Tip / Shawara:** Danna 'Copy' button, sannan liqa a wayarka ka kira. Ba sai ka rubuta da hannu ba!")
...
# KYC PAGE
    ...
    if st.session_state.kyc_status == "approved":
        ...
        with st.form("kyc_form"):
            ...
            full_name = st.text_input("Cikakken Suna / Full Name *", placeholder="Jamilu Sani")
            email = st.text_input("Email Address / Imel *", placeholder="example@gmail.com")
            phone = st.text_input("Phone Number / Lambar Wayar *", placeholder="07062589825", max_chars=11)
            dob = st.date_input("Ranar Haihuwa / Date of Birth *")
            
            st.markdown("#### 2. Identity Verification / Tabbatar da Shaida")
            id_type = st.selectbox("Nau'in ID / ID Type *", ["NIN", "BVN", "Voter's Card", "Driver's License", "International Passport"])
            ...
            submitted = st.form_submit_button("Submit KYC / Tura KYC", type="primary", use_container_width=True)
            
            if submitted:
                if not all([full_name, email, phone, id_number, address, lga, uploaded_file, agree]):
                    st.error("Dole ka cika duka filin da * / Fill all fields with *")
                else:
                    st.session_state.user_data = {
                        "full_name": full_name,
                        "email": email,
...
# PROFILE PAGE
    ...
    st.markdown(f"""
    **Business Name / Sunan Kamfani:** J.S.GLOBAL LINKS AND SERVICES  
    **CAC Registration / Rijistar CAC:** RC 8984371  
    **Business Type / Nau'in Kasuwanci:** GENERAL MERCHANDISE  
    **Address / Adireshin:** NO.278, LAYIN MAI UNGUWA KANO SAUNA, KANO STATE  
    **Phone / Waya:** 07062589825  
    **Wallet Balance / Kudin Wallet:** N{balance}
    """)
    st.success("Verified Business / An Tabbatar")
